...
;				
	...
	private void cicloDoJogo() {
		try {
			...
			while(!tabuleiro.objetivoAlcancado()) {
				...
				String digitado = caputurarValorDigitado("Digite (x, y): ");
				
				Iterator<Integer> xy = Arrays.stream(digitado.split(",")).map(e -> Integer.parseInt(e.trim())).iterator();
				
				digitado = caputurarValorDigitado("1 - Abrir ou 2 - (Des)Marcar: ");
	...
	private String caputurarValorDigitado(String texto) {
